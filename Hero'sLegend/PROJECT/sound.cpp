...
{
	{ "data/BGM/title.wav", -1 },		//タイトル曲
	{ "data/BGM/tutorial.wav", -1 },	//チュートリアル曲
	{ "data/BGM/battle.wav", -1 },		//戦う曲
	{ "data/SE/blade.wav", 0 },			//斬撃音
	{ "data/SE/menu.wav", 0 },			//選択
	{ "data/SE/gun.wav", 0 },			//銃声
	{ "data/SE/OK.wav", 0 },			//決定
	{ "data/SE/death.wav", 0 },			//やられた
	{ "data/SE/pinch.wav", 0 },			//ピンチ
	{ "data/SE/footstep.wav", 0 },		//足音
	{ "data/SE/damage.wav", 0 }			//ダメージくらった
};
