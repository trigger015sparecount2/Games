...
void InittitleUi(void)
{
	...
	g_bPressClear = true;
	pDevice = GetDevice();
	g_atitlePos[nCntUi] = D3DXVECTOR3(640.0f, 230.0f, 0.0f);//タイトル
	nCntUi++;
	g_atitlePos[nCntUi] = D3DXVECTOR3(640.0f, 600.0f, 0.0f);//PRESSENTER
	//テクスチャの読み込み
	...
	//タイトルロゴ
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x - 300, g_atitlePos[nCntUi].y - 300, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x + 300, g_atitlePos[nCntUi].y - 300, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x - 300, g_atitlePos[nCntUi].y + 300, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x + 300, g_atitlePos[nCntUi].y + 300, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//pressJkey
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x - 270, g_atitlePos[nCntUi].y - 30, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x + 270, g_atitlePos[nCntUi].y - 30, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x - 270, g_atitlePos[nCntUi].y + 30, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x + 270, g_atitlePos[nCntUi].y + 30, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
