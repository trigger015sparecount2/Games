...
void UpdatePlayer(void)
{
	...
	//ジャンプボタン押すかつ着地済み
	if (GetKeyboardKey(DIK_J) == true && g_aPlayer.bJump == true || GetGamePadButton(2) == true && g_aPlayer.bJump == true)
	{
		//ジャンプする
