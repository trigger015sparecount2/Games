...
public:
	...
	D3DXVECTOR3 GetPos() { return m_pos; }				//pos返す
	D3DXVECTOR2 GetSize() { return m_Size; }			//サイズ取得
	void SetPos(D3DXVECTOR3 pos) { m_pos = pos; }		//pos取得
	float GetSizeRot() { return m_fRot[0]; }			//サイズ取得
	...
	void SetTex(D3DXVECTOR2 Scroll, D3DXVECTOR2 TipScroll);		//テクスチャ座標設定
