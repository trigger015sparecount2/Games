...
public:
	...
	virtual void Damage(int nDamage, D3DXVECTOR3 clash) = 0;
	virtual bool GetRotX() = 0;
	virtual bool CollisionDamage(D3DXVECTOR3 pos, float fRadius, float fHeight) = 0;
	virtual bool SetEnemy(CScene *pEnemy) = 0;
	virtual int Damage() = 0;
	virtual float VClash() = 0;
	virtual float HClash() = 0;
	virtual D3DXMATRIX GetMatrix(int nPart) = 0;
