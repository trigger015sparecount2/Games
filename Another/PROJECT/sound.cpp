...
CSound::PARAM CSound::m_aParam[SOUND_LABEL_MAX] =
{
	...
	{ "data/SE/attack.wav", 0 },		// 斬撃音
	{ "data/SE/cancel.wav", 0 },		// キャンセル音
	{ "data/SE/clear.wav", 0 },			// クリア音
	{ "data/SE/damage.wav", 0 },		// 被ダメ音
	{ "data/SE/dodge.wav", 0 },			// 回避音
	{ "data/SE/enemyapp.wav", 0 },		// 敵消滅音
	{ "data/SE/enemydeath.wav", 0 },	// 敵消滅音
	{ "data/SE/footstep.wav", 0 },		// 足音
	{ "data/SE/go.wav", 0 },			// GO
	{ "data/SE/guard.wav", 0 },			// ガード音
	{ "data/SE/landing.wav", 0 },		// 着地時
	{ "data/SE/ok.wav", 0 },			// OK
	{ "data/SE/pause.wav", 0 },			// ポーズ
	{ "data/SE/pinch.wav", 0 },			// ピンチ時
	{ "data/SE/playerdeath.wav", 0 },	// プレイヤー死亡時
