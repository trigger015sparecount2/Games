...
void UpdateAircraft(void)
{
	...
	if (g_aAircraft.bDeath == false)
	{
		...
		{
		case AIRCRAFTSTATE_NORMAL:		//通常
			break;
		case AIRCRAFTSTATE_DAMAGE:		//ダメージくらった直後
			g_aAircraft.nDTime--;
			g_aAircraft.nClear--;
			...
			break;
		case AIRCRAFTSTATE_NODAMAGE:	//無敵時間
			g_aAircraft.nDTime--;
			g_aAircraft.nClear--;
			//時間に余裕ある
			...
			break;
		case AIRCRAFTSTATE_BARRIER:	//バリア中
			break;
		}
		//Oでダッシュ
		...
		//画面外
		if (g_aAircraft.pos.x <= AIRCRAFT_WIDTH / 2.0f) //左行った場合
		{
			g_aAircraft.pos.x = AIRCRAFT_WIDTH / 2.0f;
		}
		if (g_aAircraft.pos.y <= AIRCRAFT_HEIGHT / 2.0f) //上行った場合
		{
			g_aAircraft.pos.y = AIRCRAFT_HEIGHT / 2.0f;
		}
		if (g_aAircraft.pos.x >= SCREEN_WIDTH - (AIRCRAFT_WIDTH / 2.0f)) //右行った場合
		{
			g_aAircraft.pos.x = SCREEN_WIDTH - (AIRCRAFT_WIDTH / 2.0f);
		}
		if (g_aAircraft.pos.y >= SCREEN_HEIGHT - (AIRCRAFT_HEIGHT / 2.0f)) //下行った場合
		{
			g_aAircraft.pos.y = SCREEN_HEIGHT - (AIRCRAFT_HEIGHT / 2.0f);
		}
		...
		//描画
		pVtx[0].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x - AIRCRAFT_WIDTH / 2.0f), (float)(g_aAircraft.pos.y - AIRCRAFT_HEIGHT / 2.0f), g_aAircraft.pos.z);
		pVtx[1].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x + AIRCRAFT_WIDTH / 2.0f), (float)(g_aAircraft.pos.y - AIRCRAFT_HEIGHT / 2.0f), g_aAircraft.pos.z);
		pVtx[2].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x - AIRCRAFT_WIDTH / 2.0f), (float)(g_aAircraft.pos.y + AIRCRAFT_HEIGHT / 2.0f), g_aAircraft.pos.z);
		pVtx[3].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x + AIRCRAFT_WIDTH / 2.0f), (float)(g_aAircraft.pos.y + AIRCRAFT_HEIGHT / 2.0f), g_aAircraft.pos.z);
		pVtx += 4;
		pVtx[0].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x + 80.0f - SHADOW_AIRCRAFT_WIDTH / 2.0f), (float)(g_aAircraft.pos.y + 80.0f - SHADOW_AIRCRAFT_HEIGHT / 2.0f), 0.0f);
		pVtx[1].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x + 80.0f + SHADOW_AIRCRAFT_WIDTH / 2.0f), (float)(g_aAircraft.pos.y + 80.0f - SHADOW_AIRCRAFT_HEIGHT / 2.0f), 0.0f);
		pVtx[2].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x + 80.0f - SHADOW_AIRCRAFT_WIDTH / 2.0f), (float)(g_aAircraft.pos.y + 80.0f + SHADOW_AIRCRAFT_HEIGHT / 2.0f), 0.0f);
		pVtx[3].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x + 80.0f + SHADOW_AIRCRAFT_WIDTH / 2.0f), (float)(g_aAircraft.pos.y + 80.0f + SHADOW_AIRCRAFT_HEIGHT / 2.0f), 0.0f);
		g_pVtxBuffAircraft->Unlock();
	}
	//やられた
	else
	{
		...
		{
			D3DXVECTOR3 pos;
			pos = D3DXVECTOR3(g_aAircraft.pos.x - 45.0f + rand() % 90, g_aAircraft.pos.y - 60.0f + rand() % 120, 0.0f);
			SetDeath(pos, true);
		}
	}
}
...
void SetAircraft(void)
{
	...
	pVtx[0].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x - (AIRCRAFT_WIDTH / 2.0f)), (float)(g_aAircraft.pos.y - (AIRCRAFT_HEIGHT / 2.0f)), 0.0f);
	pVtx[1].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x + (AIRCRAFT_WIDTH / 2.0f)), (float)(g_aAircraft.pos.y - (AIRCRAFT_HEIGHT / 2.0f)), 0.0f);
	pVtx[2].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x - (AIRCRAFT_WIDTH / 2.0f)), (float)(g_aAircraft.pos.y + (AIRCRAFT_HEIGHT / 2.0f)), 0.0f);
	pVtx[3].pos = D3DXVECTOR3((float)(g_aAircraft.pos.x + (AIRCRAFT_WIDTH / 2.0f)), (float)(g_aAircraft.pos.y + (AIRCRAFT_HEIGHT / 2.0f)), 0.0f);
	pVtx[0].col = D3DCOLOR_RGBA(255, 255, 255, 255);
	pVtx[1].col = D3DCOLOR_RGBA(255, 255, 255, 255);
	pVtx[2].col = D3DCOLOR_RGBA(255, 255, 255, 255);
	pVtx[3].col = D3DCOLOR_RGBA(255, 255, 255, 255);
