...
#define NUMBER_WIDTH (40.0f)   //数字の高さ
#define NUMBER_HEIGHT (60.0f)  //数字の幅
...
void InitUi(void)
{
	...
	//スコア四角
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 150.0f, g_aPos[nCntUi].y - 50.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 150.0f, g_aPos[nCntUi].y - 50.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 150.0f, g_aPos[nCntUi].y + 50.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 150.0f, g_aPos[nCntUi].y + 50.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	{
		//頂点座標の設定
		pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - NUMBER_WIDTH / 2.0f, g_aPos[nCntUi].y - NUMBER_HEIGHT / 2.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + NUMBER_WIDTH / 2.0f, g_aPos[nCntUi].y - NUMBER_HEIGHT / 2.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - NUMBER_WIDTH / 2.0f, g_aPos[nCntUi].y + NUMBER_HEIGHT / 2.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + NUMBER_WIDTH / 2.0f, g_aPos[nCntUi].y + NUMBER_HEIGHT / 2.0f, 0.0f);
		//rhwの設定
		pVtx[0].rhw = 1.0f;
		pVtx[1].rhw = 1.0f;
		pVtx[2].rhw = 1.0f;
	...
	//撃墜数四角
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 70.0f, g_aPos[nCntUi].y - 45.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 70.0f, g_aPos[nCntUi].y - 45.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 70.0f, g_aPos[nCntUi].y + 45.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 70.0f, g_aPos[nCntUi].y + 45.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//戦闘機関連四角
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 90.0f, g_aPos[nCntUi].y - 170.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 90.0f, g_aPos[nCntUi].y - 170.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 90.0f, g_aPos[nCntUi].y + 170.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 90.0f, g_aPos[nCntUi].y + 170.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//HUD戦闘機
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - AIRCRAFT_WIDTH / 2.0f, g_aPos[nCntUi].y - AIRCRAFT_HEIGHT / 2.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + AIRCRAFT_WIDTH / 2.0f, g_aPos[nCntUi].y - AIRCRAFT_HEIGHT / 2.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - AIRCRAFT_WIDTH / 2.0f, g_aPos[nCntUi].y + AIRCRAFT_HEIGHT / 2.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + AIRCRAFT_WIDTH / 2.0f, g_aPos[nCntUi].y + AIRCRAFT_HEIGHT / 2.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//「%」マーク
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 25.0f, g_aPos[nCntUi].y - 25.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 25.0f, g_aPos[nCntUi].y - 25.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 25.0f, g_aPos[nCntUi].y + 25.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 25.0f, g_aPos[nCntUi].y + 25.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//特殊兵装HUD
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 27.0f, g_aPos[nCntUi].y - 24.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 27.0f, g_aPos[nCntUi].y - 24.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 27.0f, g_aPos[nCntUi].y + 24.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 27.0f, g_aPos[nCntUi].y + 24.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	nCntUi++;
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - (NUMBER_WIDTH / 2.0f + 5.0f), g_aPos[nCntUi].y - (NUMBER_HEIGHT / 2.0f + 5.0f), 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + (NUMBER_WIDTH / 2.0f + 5.0f), g_aPos[nCntUi].y - (NUMBER_HEIGHT / 2.0f + 5.0f), 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - (NUMBER_WIDTH / 2.0f + 5.0f), g_aPos[nCntUi].y + (NUMBER_HEIGHT / 2.0f + 5.0f), 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + (NUMBER_WIDTH / 2.0f + 5.0f), g_aPos[nCntUi].y + (NUMBER_HEIGHT / 2.0f + 5.0f), 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	nCntUi++;
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 12.0f, g_aPos[nCntUi].y - 24.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 12.0f, g_aPos[nCntUi].y - 24.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aPos[nCntUi].x - 12.0f, g_aPos[nCntUi].y + 24.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aPos[nCntUi].x + 12.0f, g_aPos[nCntUi].y + 24.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
...
void UpdateUi(void)
{
	...
	//スコア四角
	if (pAircraft->pos.x - (AIRCRAFT_WIDTH / 2.0f) - 150.0f <= g_aPos[0].x &&
		g_aPos[0].x <= pAircraft->pos.x + (AIRCRAFT_WIDTH / 2.0f) + 150.0f &&
		pAircraft->pos.y - (AIRCRAFT_HEIGHT / 2.0f) - 50.0f <= g_aPos[0].y &&
		g_aPos[0].y <= pAircraft->pos.y + (AIRCRAFT_HEIGHT / 2.0f) + 50.0f) //自機が近づいたら透ける
	{
		g_aUIclear[0] -= 7;
		if (g_aUIclear[0] <= 60)
		{
	...
	//撃墜数四角
	if (pAircraft->pos.x - (AIRCRAFT_WIDTH / 2.0f) - 70.0f <= g_aPos[9].x &&
		g_aPos[9].x <= pAircraft->pos.x + (AIRCRAFT_WIDTH / 2.0f) + 70.0f &&
		pAircraft->pos.y - (AIRCRAFT_HEIGHT / 2.0f) - 45.0f <= g_aPos[9].y &&
		g_aPos[9].y <= pAircraft->pos.y + (AIRCRAFT_HEIGHT / 2.0f) + 45.0f) //自機が近づいたら透ける
	{
		g_aUIclear[1] -= 7;
		if (g_aUIclear[1] <= 60)
		{
	...
	//戦闘機関連四角
	if (pAircraft->pos.x - (AIRCRAFT_WIDTH / 2.0f) - 90.0f <= g_aPos[13].x &&
		g_aPos[13].x <= pAircraft->pos.x + (AIRCRAFT_WIDTH / 2.0f) + 90.0f &&
		pAircraft->pos.y - (AIRCRAFT_HEIGHT / 2.0f) - 170.0f <= g_aPos[13].y &&
		g_aPos[13].y <= pAircraft->pos.y + (AIRCRAFT_HEIGHT / 2.0f) + 170.0f) //自機が近づいたら透ける
	{
		g_aUIclear[2] -= 7;
		if (g_aUIclear[2] <= 60)
		{
