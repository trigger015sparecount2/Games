...
void UpdateUav(D3DXVECTOR3 pos, int nLag)
{
	...
	for (nCntUav = 0; nCntUav < MAX_UAV; nCntUav++)
	{
		...
		if (g_aUav[nCntUav].bUse == true)
		{
			...
			g_pVtxBuffUav->Lock(0, 0, (void **)&pVtx, 0);
			pVtx += nCntUav * 8;
			pVtx[0].pos = D3DXVECTOR3((float)(g_aUav[nCntUav].pos.x - UAV_WIDTH / 2.0f), (float)(g_aUav[nCntUav].pos.y - UAV_HEIGHT / 2.0f), 0.0f);
			pVtx[1].pos = D3DXVECTOR3((float)(g_aUav[nCntUav].pos.x + UAV_WIDTH / 2.0f), (float)(g_aUav[nCntUav].pos.y - UAV_HEIGHT / 2.0f), 0.0f);
			pVtx[2].pos = D3DXVECTOR3((float)(g_aUav[nCntUav].pos.x - UAV_WIDTH / 2.0f), (float)(g_aUav[nCntUav].pos.y + UAV_HEIGHT / 2.0f), 0.0f);
			pVtx[3].pos = D3DXVECTOR3((float)(g_aUav[nCntUav].pos.x + UAV_WIDTH / 2.0f), (float)(g_aUav[nCntUav].pos.y + UAV_HEIGHT / 2.0f), 0.0f);
			pVtx += 4;
			pVtx[0].pos = D3DXVECTOR3((float)(g_aUav[nCntUav].pos.x + 80.0f - SHADOW_UAV_WIDTH / 2.0f), (float)(g_aUav[nCntUav].pos.y + 80.0f - SHADOW_UAV_HEIGHT / 2.0f), 0.0f);
			pVtx[1].pos = D3DXVECTOR3((float)(g_aUav[nCntUav].pos.x + 80.0f + SHADOW_UAV_WIDTH / 2.0f), (float)(g_aUav[nCntUav].pos.y + 80.0f - SHADOW_UAV_HEIGHT / 2.0f), 0.0f);
			pVtx[2].pos = D3DXVECTOR3((float)(g_aUav[nCntUav].pos.x + 80.0f - SHADOW_UAV_WIDTH / 2.0f), (float)(g_aUav[nCntUav].pos.y + 80.0f + SHADOW_UAV_HEIGHT / 2.0f), 0.0f);
			pVtx[3].pos = D3DXVECTOR3((float)(g_aUav[nCntUav].pos.x + 80.0f + SHADOW_UAV_WIDTH / 2.0f), (float)(g_aUav[nCntUav].pos.y + 80.0f + SHADOW_UAV_HEIGHT / 2.0f), 0.0f);
			g_pVtxBuffUav->Unlock();
