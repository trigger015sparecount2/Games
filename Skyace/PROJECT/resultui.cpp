...
void InitresultUi(void)
{
	...
	//リザルト(文字)
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 105.0f, g_aresultPos[nCntUi].y - 30.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 105.0f, g_aresultPos[nCntUi].y - 30.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 105.0f, g_aresultPos[nCntUi].y + 30.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 105.0f, g_aresultPos[nCntUi].y + 30.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//スコア(文字)
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 54.0f, g_aresultPos[nCntUi].y - 20.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 54.0f, g_aresultPos[nCntUi].y - 20.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 54.0f, g_aresultPos[nCntUi].y + 20.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 54.0f, g_aresultPos[nCntUi].y + 20.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//キル(文字)
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 40.0f, g_aresultPos[nCntUi].y - 20.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 40.0f, g_aresultPos[nCntUi].y - 20.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 40.0f, g_aresultPos[nCntUi].y + 20.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 40.0f, g_aresultPos[nCntUi].y + 20.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//you(文字)
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 60.0f, g_aresultPos[nCntUi].y - 30.0f, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 60.0f, g_aresultPos[nCntUi].y - 30.0f, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 60.0f, g_aresultPos[nCntUi].y + 30.0f, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 60.0f, g_aresultPos[nCntUi].y + 30.0f, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	for (nCntnumber = 0; nCntnumber < 11; nCntnumber++)
	{
		//スコアと撃墜数(数字)
		//頂点座標の設定
		pVtx[0].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 20.0f, g_aresultPos[nCntUi].y - 30.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 20.0f, g_aresultPos[nCntUi].y - 30.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x - 20.0f, g_aresultPos[nCntUi].y + 30.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_aresultPos[nCntUi].x + 20.0f, g_aresultPos[nCntUi].y + 30.0f, 0.0f);
		//rhwの設定
		pVtx[0].rhw = 1.0f;
		pVtx[1].rhw = 1.0f;
		pVtx[2].rhw = 1.0f;
