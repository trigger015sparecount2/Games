...
void InittitleUi(void)
{
	...
	//タイトルロゴ
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x - 300, g_atitlePos[nCntUi].y - 80, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x + 300, g_atitlePos[nCntUi].y - 80, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x - 300, g_atitlePos[nCntUi].y + 80, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x + 300, g_atitlePos[nCntUi].y + 80, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
	...
	//pressJkey
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x - 230, g_atitlePos[nCntUi].y - 30, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x + 230, g_atitlePos[nCntUi].y - 30, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x - 230, g_atitlePos[nCntUi].y + 30, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_atitlePos[nCntUi].x + 230, g_atitlePos[nCntUi].y + 30, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
