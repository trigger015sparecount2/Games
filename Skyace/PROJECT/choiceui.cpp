...
void InitchoiceUi(void)
{
	...
	for (nCntsquare = 0; nCntsquare < 2; nCntsquare++)
	{
		//戦闘機大枠四角
		//頂点座標の設定
		pVtx[0].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 160, g_achoicePos[nCntUi].y - 260, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 160, g_achoicePos[nCntUi].y - 260, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 160, g_achoicePos[nCntUi].y + 260, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 160, g_achoicePos[nCntUi].y + 260, 0.0f);
		//rhwの設定
		pVtx[0].rhw = 1.0f;
		pVtx[1].rhw = 1.0f;
		pVtx[2].rhw = 1.0f;
		...
		//戦闘機
		//頂点座標の設定
		pVtx[0].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 100, g_achoicePos[nCntUi].y - 130, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 100, g_achoicePos[nCntUi].y - 130, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 100, g_achoicePos[nCntUi].y + 130, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 100, g_achoicePos[nCntUi].y + 130, 0.0f);
		//rhwの設定
		pVtx[0].rhw = 1.0f;
		pVtx[1].rhw = 1.0f;
		pVtx[2].rhw = 1.0f;
		...
		{
			//頂点座標の設定
			pVtx[0].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 40, g_achoicePos[nCntUi].y - 40, 0.0f);
			pVtx[1].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 40, g_achoicePos[nCntUi].y - 40, 0.0f);
			pVtx[2].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 40, g_achoicePos[nCntUi].y + 40, 0.0f);
			pVtx[3].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 40, g_achoicePos[nCntUi].y + 40, 0.0f);
			//rhwの設定
			pVtx[0].rhw = 1.0f;
			pVtx[1].rhw = 1.0f;
			pVtx[2].rhw = 1.0f;
			...
			nCntUi++;
			//頂点座標の設定
			pVtx[0].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 30, g_achoicePos[nCntUi].y - 30, 0.0f);
			pVtx[1].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 30, g_achoicePos[nCntUi].y - 30, 0.0f);
			pVtx[2].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 30, g_achoicePos[nCntUi].y + 30, 0.0f);
			pVtx[3].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 30, g_achoicePos[nCntUi].y + 30, 0.0f);
			//rhwの設定
			pVtx[0].rhw = 1.0f;
			pVtx[1].rhw = 1.0f;
			pVtx[2].rhw = 1.0f;
	...
	//説明文四角
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 630, g_achoicePos[nCntUi].y - 80, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 630, g_achoicePos[nCntUi].y - 80, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x - 630, g_achoicePos[nCntUi].y + 80, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_achoicePos[nCntUi].x + 630, g_achoicePos[nCntUi].y + 80, 0.0f);
	//rhwの設定
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
