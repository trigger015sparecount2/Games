...
void SetDeath(D3DXVECTOR3 pos, bool bSound)
{
	...
	for (nCntDeath = 0; nCntDeath < 128; nCntDeath++)
	{
		if (g_aDeath[nCntDeath].bUse == false)
		{
			...
			pVtx[0].pos = D3DXVECTOR3(g_aDeath[nCntDeath].pos.x - (DEATH_BLOCK / 2), g_aDeath[nCntDeath].pos.y - (DEATH_BLOCK / 2), 0.0f);
			pVtx[1].pos = D3DXVECTOR3(g_aDeath[nCntDeath].pos.x + (DEATH_BLOCK / 2), g_aDeath[nCntDeath].pos.y - (DEATH_BLOCK / 2), 0.0f);
			pVtx[2].pos = D3DXVECTOR3(g_aDeath[nCntDeath].pos.x - (DEATH_BLOCK / 2), g_aDeath[nCntDeath].pos.y + (DEATH_BLOCK / 2), 0.0f);
			pVtx[3].pos = D3DXVECTOR3(g_aDeath[nCntDeath].pos.x + (DEATH_BLOCK / 2), g_aDeath[nCntDeath].pos.y + (DEATH_BLOCK / 2), 0.0f);
			g_aDeath[nCntDeath].nCounterAnim = 0;
			g_aDeath[nCntDeath].nPatternAnim = 0;
